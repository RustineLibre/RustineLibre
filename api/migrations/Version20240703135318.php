...
final class Version20240703135318 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE repairer_city (id INT NOT NULL, repairer_id INT NOT NULL, name VARCHAR(255) NOT NULL, postcode VARCHAR(255) NOT NULL, latitude VARCHAR(255) NOT NULL, longitude VARCHAR(255) NOT NULL, gps_point geography(GEOMETRY, 4326) DEFAULT NULL, PRIMARY KEY(id))');
