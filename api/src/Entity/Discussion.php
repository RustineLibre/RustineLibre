...
class Discussion
{
    ...
    #[ORM\GeneratedValue]
    #[ORM\Column]
    #[Groups([self::DISCUSSION_READ, Appointment::APPOINTMENT_READ, Appointment::REPAIRER_APPOINTMENT_COLLECTION_READ, Appointment::CUSTOMER_APPOINTMENT_COLLECTION_READ])]
    public ?int $id = null;
