...
#[ApiResource(
    operations: [
        new Post(
            securityPostValidation: "is_granted('ROLE_ADMIN') or (is_granted('ROLE_BOSS') and user.isAssociatedWithRepairer(object.repairer) and is_granted('REPAIRER_INTERVENTION_WRITE', object))",
        ),
    ],
